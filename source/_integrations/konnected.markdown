...
This integration automatically discovers your Konnected devices. If you don't want to use discovery, set the `host` and `port` for each device in the description.
